...
public class VnpayConfig {
    ...
    public static String vnp_Returnurl = "http://localhost:3000/result/payment";
    public static String vnp_TmnCode = "VMMBOT14";
    public static String vnp_HashSecret = "LKBKTLFJDSWNMLZSUBMEYMMQTDQFUYCX";
